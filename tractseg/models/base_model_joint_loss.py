    ...
    def train(self, X, y, weight_factor=None):
        ...
        if weight_factor is not None:
            ...
            if self.Config.LOSS_FUNCTION == "soft_sample_dice" or self.Config.LOSS_FUNCTION == "soft_batch_dice":
                ...
                loss_1 = self.joint_loss(outputs[0], y)
                loss_2 = self.joint_loss(outputs[1], y)
                loss_3 = self.joint_loss(outputs[2], y)
                loss_4 = self.joint_loss(outputs[3], y)
                loss_5 = self.joint_loss(outputs[4], y)
