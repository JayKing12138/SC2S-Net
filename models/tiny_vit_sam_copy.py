...
class TinyViT(nn.Module):
    def __init__(self, img_size=224, in_chans=9, num_classes=1000,
...
image_encoder=TinyViT(img_size=1024, in_chans=3, num_classes=0,
    embed_dims=[64, 128, 160, 320],
...
print(stat(image_encoder, (3, 1024, 1024)))
