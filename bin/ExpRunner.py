...
def main():
    ...
    parser.add_argument("--weights_path", default=False)
    ...
    # Config.VALIDATE_SUBJECTS = ["623844"]
    # Config.TEST_SUBJECTS.append("623844")
    ...
    if Config.SEGMENT:
        # exp_utils.make_dir(join("/data/userdisk1/crq/TractSeg/segmentations"))
    ...
    if Config.TEST:
        # trainer.test_whole_subject(Config, model_test, Config.TEST_SUBJECTS, "test")
        for i in range(len(Config.VALIDATE_SUBJECTS)):
            VALIDATE_SUBJECT = [Config.VALIDATE_SUBJECTS[i]]
            trainer.test_whole_subject(Config, model_test, VALIDATE_SUBJECT, "validate")
