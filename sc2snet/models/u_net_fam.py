...
class UNet_FAM(torch.nn.Module):
    def __init__(self, n_input_channels, n_classes=1, n_filt=64, batchnorm=False, dropout=False, upsample="bilinear"):
        ...
        #Adaptive_avg_pool
        self.GAP_1 = nn.functional.adaptive_avg_pool2d(n_filt, (144, 144))

        self.contr_2_1 = conv2d(n_filt, n_filt * 2)
        self.contr_2_2 = conv2d(n_filt * 2, n_filt * 2)
        self.pool_2 = nn.MaxPool2d((2, 2))

        self.GAP_2 = nn.functional.adaptive_avg_pool2d(n_filt*2,(72,72))
    ...
    def forward(self, inpt):
        ...
        mul_1 = torch.mul(gap_2,expand_2_2)
        add_1 = torch.add(mul_1,expand_2_2)

        # deconv_3 = self.deconv_3(expand_2_2)
        deconv_3 = self.ps_3(add_1)
        ...
        gap_1 = self.GAP_1(expand_3_2)
        mul_2 = torch.mul(gap_1, expand_3_2)
        add_2 = torch.add(mul_2, expand_3_2)

        deconv_4 = self.ps_4(add_2)
