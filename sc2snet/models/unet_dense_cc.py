...
class UNet_Dense_CC(torch.nn.Module):
    def __init__(self, n_input_channels, n_classes=1, n_filt=64, batchnorm=False, dropout=False, upsample="bilinear"):
        ...
        self.atte1_1 = CrissCrossAttention(n_filt)
        self.atte1_2 = CrissCrossAttention(n_filt)
        self.pool_1 = nn.MaxPool2d((2, 2))

        self.contr_2_1 = conv2d(n_filt, n_filt * 2)
        self.contr_2_2 = conv2d(n_filt * 2, n_filt * 2)
        self.atte2_1 = CrissCrossAttention(n_filt * 2)
        self.atte2_2 = CrissCrossAttention(n_filt * 2)
        self.pool_2 = nn.MaxPool2d((2, 2))

        self.contr_3_1 = conv2d(n_filt * 2, n_filt * 4)
        self.contr_3_2 = conv2d(n_filt * 4, n_filt * 4)
        self.atte3_1 = CrissCrossAttention(n_filt * 4)
        self.atte3_2 = CrissCrossAttention(n_filt * 4)
        self.pool_3 = nn.MaxPool2d((2, 2))

        self.contr_4_1 = conv2d(n_filt * 4, n_filt * 8)
        self.contr_4_2 = conv2d(n_filt * 8, n_filt * 8)
        self.atte4_1 = CrissCrossAttention(n_filt * 8)
        self.atte4_2 = CrissCrossAttention(n_filt * 8)
        ...
        self.atte5_2 = DenseCCABlock(n_filt * 16)
